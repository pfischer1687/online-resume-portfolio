      ...
      <section className={`${styles.education} divider`}>
        ...
        <section>
          ...
          <ul>
            <li className={styles.certsBullet}>
              ...
              Intermediate React, v6 (07/2025), Complete Intro to React, v8
              (07/2025)
            </li>
            <li className={styles.certsBullet}>
              <span className={styles.educationTitle}>LinkedIn Learning:</span>{" "}
              Advanved Rust: Managing Projects (06/2023), Rust Essential
              Training (06/2023), Advanced NLP with Python for Machine Learning
              (01/2023), Parallel and Concurrent Programming with C++ (12/2022),
              C Programming for Embedded Applications (12/2022), Advanced Linux:
              The Linux Kernel (12/2022), Linux Device Drivers (12/2022), Become
              a Full-Stack Web Developer (10/2022), Tableau and R for Analytics
              Projects (02/2022), Learning Assembly Language (12/2021), Ethical
              Hacking: Scanning Networks (08/2021)
            </li>
            <li className={styles.certsBullet}>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Mastering Computational Physics (PHYS 562): Numerical simulation
              of physical systems using ODE/PDE solvers, Monte Carlo methods,
              optimization, and linear algebra (LAPACK), with applications in
              quantum mechanics and scattering problems.
            </li>
          </ul>
        </section>
